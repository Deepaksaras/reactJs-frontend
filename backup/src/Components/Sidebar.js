    ...
    <div>
      <div className="newsidebar">
        <ul className="mt-2">
          ...
          <li>
            <NavLink exact to="/dashboard" className="tooltip-right" data-tooltip="Dashboard"  >
               <i className="lnil lnil-display-alt" />
            </NavLink>
          </li>
          <li>
            <NavLink to="/date" className="tooltip-right" data-tooltip="Employee Management"  >
          ...
          <li><NavLink to="#" className="tooltip-right" data-tooltip="Logs"><i className="lnil lnil-laptop-alt-switch" /></NavLink></li>
        </ul>
